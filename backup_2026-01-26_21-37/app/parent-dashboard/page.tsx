...
export default function ParentDashboardPage() {
  ...
  const handleChildAction = (action: string) => {
    if (!canModifyChild) {
      // Parents have view-only access to child profiles
      return;
    }
          ...
          <header className="mb-10">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-4">
                    ...
                    <div className="w-8 h-8 rounded-full bg-gradient-to-r from-[#00C2E0] to-[#00a8c2] flex items-center justify-center text-white font-bold">
                      P
                    </div>
