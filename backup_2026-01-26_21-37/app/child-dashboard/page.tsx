      ...
      <main className="main-content ml-64 flex-1 p-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10">
          ...
          <div className="mt-4 md:mt-0 flex items-center gap-4">
            {/* UPDATED: Child Avatar Badge with Profile Picture */}
            <div className="flex items-center gap-3 px-4 py-2 bg-white rounded-xl shadow-sm border border-gray-200">
              <div className="w-8 h-8 rounded-full flex items-center justify-center overflow-hidden">
                {isClient && profileImage ? (
                  ...
                  <div className="w-full h-full bg-gradient-to-r from-cyan-500 to-teal-500 flex items-center justify-center text-white font-bold">
                    C
                  </div>
                )}
              </div>
