...
export default function Header() {
  ...
  return (
    <header className="header-container fixed top-0 left-0 right-0 z-50 bg-[#F0F9FF]/40 backdrop-blur-[8px] border-b border-white/30 shadow-[0_4px_30px_rgba(0,0,0,0.05)] px-20 py-5 flex justify-between items-center">
      ...
      <nav className="nav-actions flex items-center gap-6">
        {/* About Link */}
        <Link
          href="/about"
          className="nav-link no-underline text-[#4A5568] text-base font-medium relative transition-colors duration-300 hover:text-[#00C2E0] after:content-[''] after:absolute after:-bottom-1 after:left-0 after:w-0 after:h-0.5 after:bg-[#00C2E0] after:transition-all after:duration-300 hover:after:w-full"
        >
          About
        </Link>
        ...
        <button
          ...
          className="get-started-button bg-white text-[#00C2E0] border-2 border-[#00C2E0] px-7 py-3 rounded-xl font-bold text-base cursor-pointer shadow-[0_4px_12px_rgba(0,194,224,0.2)] hover:shadow-[0_6px_16px_rgba(0,194,224,0.3)] hover:transform hover:-translate-y-[2px] active:transform active:translate-y-0 active:shadow-[0_2px_8px_rgba(0,194,224,0.2)] transition-all duration-300 hover:bg-[#00C2E0] hover:text-white"
        >
          Get Started
        </button>
