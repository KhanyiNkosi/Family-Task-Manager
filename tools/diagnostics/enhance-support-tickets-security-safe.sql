...
-- SAFE VERSION: Adds missing columns if needed, works with existing schema
...
-- Add assignee_id column if missing (this is the correct column name based on error)
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.columns 
